    ...
    public partial class MigrationDefaultDbFirst : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Apps",
                columns: new[] { "Id", "DatabaseName", "Domain", "HotelName", "IsDeleted", "IsPassword", "Password", "ServerName", "UserName" },
                values: new object[,]
                {
                    { 1, "HotelDb1", "grand-ocean.com", "Grand Ocean Resort", false, false, "SecurePassword123", "MSI", "admin" },
                    { 2, "HotelDb2", "luxeretreat.com", "Luxe Retreat", false, false, "", "MSI", "user1" }
                });
