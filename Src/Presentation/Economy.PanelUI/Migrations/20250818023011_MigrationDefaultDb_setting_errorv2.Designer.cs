...
namespace Economy.Panel.UI.Migrations
{
    ...
    [Migration("20250818023011_MigrationDefaultDb_setting_errorv2")]
    partial class MigrationDefaultDb_setting_errorv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Economy.Domain.Entites.AppEntities.AppGeneralSetting", b =>
                {
                    ...
                    b.Property<string>("MetaTitleSuffix")
                        .HasMaxLength(120)
                    ...
                    b.ToTable("AppGeneralSettings", (string)null);
                });

            modelBuilder.Entity("Economy.Domain.Entites.AppEntities.AppManager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Economy.Domain.Entites.AppEntities.AppSecuritySetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LockoutTimeSpanMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(30);
                    ...
                    b.Property<bool>("SignInRequireConfirmedPhoneNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.ToTable("AppSecuritySettings", (string)null);
                });
            ...
            modelBuilder.Entity("Economy.Domain.Entites.AppEntities.AppManager", b =>
                {
                    b.HasOne("Economy.Domain.Entites.AppEntities.App", "App")
                        .WithMany()
                        .HasForeignKey("AppId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Economy.Domain.Entites.Identities.AppUser", "User")
                        .WithMany()
