...
! function (e) {
    ...
    function Q(h, o) {
        var t, e = h.root,
            i = h.classes,
            p = [];
        e.id || (window.splide = window.splide || {}, t = window.splide.uid || 0, window.splide.uid = ++t, e.id = "splide" + v(t));
        var r = {
            mount: function () {
                var t = this;
                ! function () {
                    r.slider = _(e, i.slider), r.track = a(e, "." + i.track), r.list = _(r.track, i.list), N(r.track && r.list, "Track or list was not found."), r.slides = c(r.list, i.slide);
                    var t = s(i.arrows);
                    r.arrows = {
                        prev: a(t, "." + i.prev),
                        next: a(t, "." + i.next)
                    ...
                    var n = s(i.autoplay);
                    r.bar = a(s(i.progress), "." + i.bar), r.play = a(n, "." + i.play), r.pause = a(n, "." + i.pause), r.track.id = r.track.id || e.id + "-track", r.list.id = r.list.id || e.id + "-list"
            ...
            init: function () {
                C(e, n()), r.slides.forEach(function (t, n) {
                    r.register(t, n, -1)
                })
            },
    ...
    function $(r, s) {
        var i, n, o, e = r.options.direction === it,
            ...
            d = {
                ...
                go: function (t, n, e) {
                    var i = f(t),
                        o = r.index;
                    r.State.is(U) && u || (u = t !== n, e || r.emit("move", n, o, t), 1 <= Math.abs(i - this.position) || a ? s.Transition.start(t, n, o, this.toCoord(i), function () {
                        l(t, n, o, e)
        ...
        function l(t, n, e, i) {
            P(o, {
                transition: ""
            }), u = !1, a || d.jump(n), i || r.emit("moved", n, e, t)
        }
    ...
    function tt(o, t) {
            ...
            e.destroy(),
                function (i) {
                    ...
                    r.slice(0, i).forEach(function (t, n) {
                        ...
                        var e = u(t);
                        S(e, r[0]), s.push(e), a.register(e, n - i, (o + n - i % o) % o)
                    })
                }(n = r())
        }
        ...
        function r() {
            ...
            var n = t.autoWidth || t.autoHeight ? a.length : t.perPage,
                ...
                i = t["fixed" + e];
            return i && (n = Math.ceil(a.track["client" + e] / i)), n * (t.drag ? t.flickMaxPages + 1 : 1)
        }
    ...
    var nt = function () {
            ...
            return o.mount = function (t, n) {
                var e, i, o, r, s = this;
                void 0 === t && (t = this._e), void 0 === n && (n = this._t), this._e = t, this._t = n, this.Components = (i = u((e = this)._c, t), o = n, r = {}, m(i, function (t, n) {
    ...
    function pt(a, e) {
        ...
        function s(t, n) {
            n && M(n.button, _t, !0), t.items.forEach(function (t) {
                var n = a.options,
        ...
        return {
            ...
            mount: function () {
                a.on("visible", function (t) {
                    ...
                    var n = i[t];
                    n && (f(n) || M(n, "role", "button"), M(n, Et, i.track.id), M(n, kt, u[t]))
                })
            },
            destroy: function () {
                var t = e.Arrows,
                    ...
                    mount: function () {
                        o.on("mounted updated", function () {
                            var t = o.options,
                                ...
                                e = Ct[t.direction],
                                i = t.keyboard;
                            r && (o.off("keydown", r), A(n, Pt)), i && ("focused" === i ? M(r = n, Pt, 0) : r = document, o.on("keydown", function (t) {
