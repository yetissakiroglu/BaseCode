...
function addImageToGallery(gi, url) {
    ...
    <!-- .Index eşlemesi -->
    <input type="hidden" name="Galleries[${gi}].Items.Index" value="${key}" />
    <input type="hidden" name="Galleries[${gi}].Items[${key}].Id" value="0" />
    <input type="hidden" name="Galleries[${gi}].Items[${key}].MediaUrl" value="${url}" />
  `;
