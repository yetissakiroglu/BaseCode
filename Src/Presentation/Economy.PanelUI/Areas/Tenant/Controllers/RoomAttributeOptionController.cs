...
namespace Economy.Panel.UI.Areas.Tenant.Controllers
{
    ...
    public class RoomAttributeOptionController : BaseController
    {
        ...
        public RoomAttributeOptionController(HotelDbContext db)
        {
            _db = db;
        }
        // Belirli bir attribute’a ait seçenek listesi
        public IActionResult Index(int attributeId)
        {
            var attr = _db.DefRoomAttributes.FirstOrDefault(x => x.Id == attributeId);
            if (attr == null) return NotFound();

            var list = _db.DefRoomAttributeOptions
                .Where(o => o.DefRoomAttributeId == attributeId)
                .OrderBy(o => o.SortOrder)
                .Select(o => new RoomAttributeOptionEditVm
                {
                    Id = o.Id,
                    DefRoomAttributeId = o.DefRoomAttributeId,
                    AttributeCode = attr.Code,
                    Value = o.Value,
                    SortOrder = o.SortOrder,
                    IsActive = o.IsActive,
                    DisplayNameTr = o.Translations
                        .Where(t => t.AppLanguage.Code == "tr")
                        .Select(t => t.DisplayName)
                        .FirstOrDefault() ?? "",
                    DisplayNameEn = o.Translations
