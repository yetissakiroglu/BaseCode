...
namespace Economy.Web.Demo1.Helpers
{
    public class SeoHelper : ISeoHelper
    {
        ...
        public SeoHelper( IActionContextAccessor ac, IUrlHelperFactory urlFactory, ISiteConfigAccessor cfg)
        { _ac = ac; _urlFactory = urlFactory; _cfg = cfg; }
            ...
            string? xDefaultUrl = null)
        {
            ...
            var langs =  cfg.Technical.SupportedLanguages;
            ...
            var hreflangs = langs.Select(l => (l, BuildAbs(l, routeValuesBase))).ToList();
