...
{
    public class AppContentTranslationCreateEditDtoValidator : AbstractValidator<AppContentTranslationCreateEditDto>
    {
        public AppContentTranslationCreateEditDtoValidator()
        {
