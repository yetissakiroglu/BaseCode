...
namespace Economy.Persistence.Tenant.Services
{
    public class PanelAppSlideService : IPanelAppSlideService
    {
        ...
        public ServiceResult<AppSlideDto> CreateSlide(AppSlideCreateEditDto model)
        {
            ...
            return ServiceResult<AppSlideDto>.Success(null,
        ...
        public ServiceResult<AppSlideDto> DeleteSlide(int id)
        {
            ...
            return ServiceResult<AppSlideDto>.Success(null, "Slide başarıyla silindi.");
        }
        ...
        public ServiceResult<AppSlideDto> GetSlide(int id, bool isDeleted)
        {
            ...
            return ServiceResult<AppSlideDto>.Success(data: null, message: "Slide başarıyla getirildi.", statusCode: (int)HttpStatusCode.OK);
        }
    }
}
